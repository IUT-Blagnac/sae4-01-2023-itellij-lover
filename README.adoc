...
Nous avons enlevé la classe interne Match car nous trouvions ça redondant d'avoir Match et MatchM, nous avons donc fait le choix de garder uniquement MatchM et d'y créer un constructeur qui ressemble a celui de Match.
